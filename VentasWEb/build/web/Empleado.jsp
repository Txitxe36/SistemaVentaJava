        ...
        <div class="d-flex">
            ...
            <div class="col-sm-8">
                <table class="table table-hover">
                    <label class="text-center m-2">LISTA DE EMPLEADOS</label>
                    <thead>
                    <th>ID</th>
                    <th>DNI</th>
                    <th>NOMBRES</th>
                    ...
                    <tbody>
                        <c:forEach var="emple" items="${empleados}">
                            <tr>
                                ...
                                <td>${emple.getUser()}</td>
                                <td>
                                    <a class="btn btn-warning" href="Controlador?menu=Empleado&accion=Editar&idEmp=${emple.getId()}">Editar</a>
                                    <a class="btn btn-danger" href="Controlador?menu=Empleado&accion=Delete&idEmp=${emple.getId()}">Borrar</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
